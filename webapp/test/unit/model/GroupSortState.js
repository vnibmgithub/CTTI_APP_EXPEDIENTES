sap.ui.define([
	"CRUD_EXP/CRUD_Exp/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Objecte").length, 1, "The sorting by Objecte returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Objecte and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Objecte");
