sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("CRUD_EXP/CRUD_Exp/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#Expedients-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#Expedients-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("CRUD_EXP.CRUD_Exp.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["CRUD_EXP/CRUD_Exp/localService/mockserver"], function (mockserver) {
