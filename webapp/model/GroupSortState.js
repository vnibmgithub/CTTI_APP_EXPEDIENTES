sap.ui.define([
	...
	return BaseObject.extend("CRUD_EXP.CRUD_Exp.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias CRUD_EXP.CRUD_Exp.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "Objecte");
			}
