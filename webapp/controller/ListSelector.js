sap.ui.define([
	...
	return BaseObject.extend("CRUD_EXP.CRUD_Exp.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias CRUD_EXP.CRUD_Exp.model.ListSelector
		 */
		 ...
		 * @return {CRUD_EXP.CRUD_Exp.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
